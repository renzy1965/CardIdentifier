...
def load_model():
    ...
    model_paths = [
        ...
        './models/best_model.keras',  # ./models directory
        '/content/best_model.keras',  # Colab path
        os.path.join(os.path.dirname(__file__), 'best_model.keras')  # Relative to script
    ]
    ...
    2. The model is named 'best_model.keras'
