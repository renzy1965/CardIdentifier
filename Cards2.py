...
# Page configuration
st.set_page_config(
    page_title="Playing Cards Classification",
    layout="wide",
...
class_info = {
    name: f"Detailed information about {name.lower()} and its function." 
...
def main():
    # Header
    st.markdown("""
        <h1 style='text-align: center; color: #2E7D32;'>Playing Cards Classification</h1>
    ...
    with st.sidebar:
        ...
        st.info("""
            This application uses machine learning to playing cards.
            It can recognize 52 different types of cards with high accuracy.
        """)
